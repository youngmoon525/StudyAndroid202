...
public class MainActivity extends AppCompatActivity {
    ...
    //ImageView imgv_kym; // 전역 변수 선언 초기상태 null
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        //context는 화면에 보이는 기능을 사용할때 현재 화면에 보이는 클래스인지를
        //판단한다라고 생각하고 Activity의 경우 무조건 화면에 보이기 떄문에
        //this를 써주면 된다.
        ...
        setContentView(layout);//<= R클래스로 존재하는 layout내부에 있는 모든것들을 java에서 사용할수있게 연결.
        // new로 초기화는 새로 인스턴스화 x
        // 디자인 파일에 이미 존재하는 객체 ImageView를 내가 선언한 변수와 연결,대입 ( 초기화 식 )
        // 태그에 있는것을 아이디로 찾을때 썼던 자바스크립트 함수 ?==>
//        imgv_kym = findViewById(R.id.imgv_kym);//@IdRes== R클래스에서 내용을 찾아서 넣어주세요.  ctrl + p
//
//        // 인터페이스 옵저버 패턴
//        imgv_kym.setOnClickListener(new View.OnClickListener() {
//            @Override
...
//        KymOnClickListener onClickListener = new KymOnClickListener() {
//            @Override
//            public void onClick(String data) {
//                Toast.makeText(MainActivity.this, "메소드 실행되었습니다.KYM", Toast.LENGTH_SHORT).show();
//            }
//        };
...
//    public void setOnclickListener(KymOnClickListener onClickListener){
//
//    }

//    public interface  KymOnClickListener {
//        public void onClick(String data);
//    }
