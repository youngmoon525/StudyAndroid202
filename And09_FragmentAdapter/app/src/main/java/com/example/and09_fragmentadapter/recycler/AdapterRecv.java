...
// 상속을 받을때 ViewHolder가 필요함. RecyclerView.Adapter<VH> => VH : ViewHolder
public class AdapterRecv extends RecyclerView.Adapter<AdapterRecv.KymViewHolder>{
    ...
    public void onBindViewHolder(@NonNull KymViewHolder h, int i) {
        ...
        h.tv_adress.setText(list.get(i).getAdress());
    ...
    public class KymViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView tv_gender , tv_name , tv_age , tv_adress;
        Button btn_detail;
        public KymViewHolder(@NonNull View v) {
            ...
            tv_adress = v.findViewById(R.id.tv_adress);
